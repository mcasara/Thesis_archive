...
os.chdir('ADVI_'+str(int(sys.argv[2])))
...
intercept=[]
tracedata=[]
testt = approx.sample(draws=200)
# testt=mean_field.sample(1000)
for k in range (len(testt)):
    ...
    intercept.append(testt[k]['Intercept'])
    tracedata.append([testt[k]['weight_'+str(i)] for i in listenonzeroweights])
